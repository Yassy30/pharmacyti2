...
class _ProfileInfosState extends State<ProfileInfos> {
  final TextEditingController nameController = TextEditingController(text: "Healthy pharmacie");
  final TextEditingController emailController = TextEditingController(text: "healthypharma@gmail.com");
